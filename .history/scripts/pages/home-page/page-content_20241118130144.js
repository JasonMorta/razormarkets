...
//section 4
const section4H1 = document.querySelector('.hero-image-text-content > h1').textContent = section4.heading;
const section4p = document.querySelector('.hero-image-text-content > p').textContent = section4.subheading


// section 6
const section6H1 = document.querySelector('.section-6 > h1').textContent = section6.heading;
